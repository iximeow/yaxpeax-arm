...
fn test_decode_str_ldr() {
    ...
    // Check that this still works when the high-order 4 bits of the immediate are zero. This
    // guards against regressions in the decode logic for the immediate version of LDRSH.
    test_all([0xfb, 0x30, 0xf5, 0xe1], "ldrsh r3, [r5, 0xb]!");
    // Check that this still works when the high-order 4 bits of the immediate are zero. This
    // guards against regressions in the decode logic for the immediate version of LDRSB.
