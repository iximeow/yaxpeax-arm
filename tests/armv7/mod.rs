...
fn test_cmp_immediate_decode() {
    test_all([0xaf, 0x00, 0x56, 0xe3], "cmp r6, 0xaf");
    test_all([0xaf, 0x00, 0x76, 0xe3], "cmn r6, 0xaf");
}

#[test]
fn test_cmp_register_decode() {
    test_all([0x01, 0x00, 0x52, 0xe1], "cmp r2, r1");
    test_all([0x01, 0x03, 0x52, 0xe1], "cmp r2, r1, lsl 6");
    test_all([0x11, 0x03, 0x52, 0xe1], "cmp r2, r1, lsl r3");
    test_all([0x01, 0x00, 0x72, 0xe1], "cmn r2, r1");
    test_all([0x01, 0x03, 0x72, 0xe1], "cmn r2, r1, lsl 6");
    test_all([0x11, 0x03, 0x72, 0xe1], "cmn r2, r1, lsl r3");
}

#[test]
fn test_tst_immediate_decode() {
    test_all([0xe6, 0x00, 0x18, 0xe3], "tst r8, 0xe6");
    test_all([0xe6, 0x00, 0x38, 0xe3], "teq r8, 0xe6");
}

#[test]
fn test_tst_register_decode() {
    test_all([0x01, 0x00, 0x12, 0xe1], "tst r2, r1");
    test_all([0x01, 0x03, 0x12, 0xe1], "tst r2, r1, lsl 6");
    test_all([0x11, 0x03, 0x12, 0xe1], "tst r2, r1, lsl r3");
    test_all([0x01, 0x00, 0x32, 0xe1], "teq r2, r1");
    test_all([0x01, 0x03, 0x32, 0xe1], "teq r2, r1, lsl 6");
    test_all([0x11, 0x03, 0x32, 0xe1], "teq r2, r1, lsl r3");
}
