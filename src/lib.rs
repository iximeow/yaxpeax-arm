...
//! decoder for `aarch64` (ARMv8, ARMv9).
//!
//! ## usage
//!
...
pub mod armv7;
/// `yaxpeax-arm`'s `AArch64` decoder and `Arch` implementation.
pub mod aarch64;
